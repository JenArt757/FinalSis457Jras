...
namespace FinalSis457Jras.Controllers
{
    ...
    {
        private readonly FinalSis457JrasContext _context;

        public SerieController(FinalSis457JrasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
           ...
           /* var usuario = new Usuario();
            ...
            return _context.Series != null ?
              ...
              Problem("Entity set 'FinalSis457JrasContext.Productos'  is null.");
